...
const TigrayCharts = {
    ...
    addChartInteractivity: function() {
        // Chart interactivity is now handled during chart creation
        // Download buttons are added via addChartDownloadButton()
        console.log('Chart interactivity initialized');
    },
